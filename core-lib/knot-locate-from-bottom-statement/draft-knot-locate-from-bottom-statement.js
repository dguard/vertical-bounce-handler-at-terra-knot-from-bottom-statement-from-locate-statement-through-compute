...
function Pencil() {
    ...
    that.intoPointerBelongingsCollection = function () {
        let pointerBelongingsCollectionOfFour = {
            pointerBelongingsAtTopLeft: knotThrough.pointerBelongingsAtTopLeft
            pointerBelongingsAtBottomLeft: knotThrough.pointerBelongingsAtBottomLeft
            pointerBelongingsAtRightBottom: knotThrough.pointerBelongingsAtRightBottom
            pointerBelongingsAtRightTop: knotThrough.pointerBelongingsAtRightTop
        }
    ...
    that.drawThrough = function (knotThroughInstance) {
        ...
        knotThrough.compute().constructPointerBelongingsFromBottom()
